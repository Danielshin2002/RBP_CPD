...
For each prediction date : <br>
Construct training sample as an expanding window <br>
Compute relevance for past observations <br>
Apply observation censoring thresholds<br>
Generate prediction weights<br>
Compute prediction as weighted average<br>
Compute reliability metrics (fit and ffit)<br>
Aggregate across the grid <br>
